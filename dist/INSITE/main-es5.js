...
var GlaciatorParameters = /** @class */ (function () {
    function GlaciatorParameters(fd) {
        console.log(fd);
    }
...
var ENumAsStringPipe = /** @class */ (function () {
    ...
    ENumAsStringPipe.prototype.transform = function (value, enumType) {
...
var JobSubmissionComponent = /** @class */ (function () {
    ...
    JobSubmissionComponent.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(JobSubmissionComponent.prototype, "f", {
        get: function () { return this.submissionForm.controls; },
        enumerable: true,
        configurable: true
    });
    JobSubmissionComponent.prototype.onSubmit = function (event) {
        var _this = this;
        this.submitted = true;
        ...
        var validated_data = this.submissionForm.value;
    ...
    JobSubmissionComponent.prototype.createJob = function (data) {
        this.job.uuid = Object(uuid__WEBPACK_IMPORTED_MODULE_3__["v4"])();
    ...
    JobSubmissionComponent.prototype.onReset = function () {
        this.submitted = false;
...
var JobsComponent = /** @class */ (function () {
    ...
    JobsComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getJobs().subscribe(function (data) {
            console.log(data);
            _this.jobs = data; // TODO sort ordering (by status?)
        });
        this.dataService.getQueue().subscribe(function (data) {
            console.log(data);
            _this.queue = data;
        });
    };
...
var JobstateComponent = /** @class */ (function () {
    function JobstateComponent() {
    }
    JobstateComponent.prototype.ngOnInit = function () {
    };
