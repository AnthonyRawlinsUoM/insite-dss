...
let JobSubmissionComponent = class JobSubmissionComponent {
    constructor(router, dataService) {
        ...
        this.weather_options = [
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["WeatherMachineKind"].Interpol, label: "Interpolated" },
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["WeatherMachineKind"].NarclimFuture, label: "NARCLIM Future" },
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["WeatherMachineKind"].NarclimObserved, label: "NARCLIM Observed" }
        ];
        this.fuel_options = [
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["FuelMachineKind"].InvexpWithLandis, label: "Inverse Exponential with LANDIS" },
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["FuelMachineKind"].NarclimFutureWithLandis, label: "NARCLIM Future with LANDIS" },
