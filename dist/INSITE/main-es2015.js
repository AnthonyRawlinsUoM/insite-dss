...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WeatherOptions", function() { return WeatherOptions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FuelOptions", function() { return FuelOptions; });
...
/* harmony import */ var _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../GlaciatorParameters */ "./src/app/GlaciatorParameters.ts");
...
let JobSubmissionComponent = class JobSubmissionComponent {
    constructor(router, dataService) {
        ...
        this.zone_options = [
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["Zones"].APZ, label: "APZ" },
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["Zones"].BPZ, label: "BPZ" },
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["Zones"].LMZ, label: "LMZ" }
        ];
        this.weather_options = [
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["WeatherOptions"].OBSERVED, label: "Observed" },
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["WeatherOptions"].NARCLIM_CURRENT, label: "NARCLIM Current" },
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["WeatherOptions"].NARCLIM_FUTURE, label: "NARCLIM Future" }
        ];
        this.fuel_options = [
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["FuelOptions"].MCFUEL, label: "McColl-Gausden Fuel Model" },
            { option: _GlaciatorParameters__WEBPACK_IMPORTED_MODULE_5__["FuelOptions"].INV_EXP, label: "Inverse Exponential" },
        ];
    ...
    with_harvesting_change(ev) {
        ...
        if (!ev && !this.harvesting_on && !this.harvesting_off)
            this.harvesting_off = true;
    }
    ...
    observed_change(ev) {
        ...
        if (ev && this.NARCLIM_current_weather && this.NARCLIM_future_weather)
            this.NARCLIM_future_weather = false;
    }
    ...
    NARCLIM_future_weather_change(ev) {
        ...
        if (ev && this.observed_weather && this.NARCLIM_future_weather)
            this.NARCLIM_future_weather = false;
    }
};
